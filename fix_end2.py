# Fix the end of app.js
with open(r'C:\Users\cct\Documents\Default Project\nutrition-battle\public\app.js', 'r', encoding='utf-8') as f:
    content = f.read()

# Check if already fixed
if 'if (document.readyState === \'loading\')' in content:
    print('Already fixed')
else:
    # Find the end of the file and add the missing code
    additional = """
...
"""
    ...
    with open(r'C:\Users\cct\Documents\Default Project\nutrition-battle\public\app.js', 'w', encoding='utf-8') as f:
        f.write(content)
    print('Fixed: Added missing closing code')